...
- [`morphospace_axes()`](https://momx.github.io/Momstats/reference/morphospace_axes.md)
  : Morphospace visualization: shapes along axes
- [`morphospace_centroids()`](https://momx.github.io/Momstats/reference/morphospace_centroids.md)
  : Morphospace visualization: group centroids
- [`morphospace_grid()`](https://momx.github.io/Momstats/reference/morphospace_grid.md)
  : Morphospace visualization: uniform grid
- [`morphospace_range()`](https://momx.github.io/Momstats/reference/morphospace_range.md)
...
- [`plot(`*`<stat_meanshape>`*`)`](https://momx.github.io/Momstats/reference/plot.stat_meanshape.md)
  : Plot mean shapes
- [`stat_meanshape()`](https://momx.github.io/Momstats/reference/stat_meanshape.md)
...
- [`vitis`](https://momx.github.io/Momstats/reference/vitis.md) :
  Grapevine pips outlines (two views) with elliptic Fourier transform
  coefficients
